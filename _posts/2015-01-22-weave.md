...
In order to use Mesos or Marathon health checks the mesos-slave IP is used. Mesos doesn't know about the internal container IPs. This is certainly worth a pull request, but I haven't done that yet.
