...
Finally it should be highlighted that Galera's cluster logic really feels like a great fit with the dynamic nature of a Mesos cluster. This is in contrast to a lot of other services which come from the static pre-Docker world. So I completely agree with [Erkan Yanar](http://linsenraum.de/erkules/) that Galera does a lot of things right.
